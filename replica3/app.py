...
# app.mount("/replica3/videos", StaticFiles(directory=VIDEOS_ROOT), name="videos")
...
# REPLICA CONFIG
# ---------------------------------------------------
REPLICA_ID = "replica3"   # change to replica2 / replica3 in other replicas
...
# Thumbnails
# Caddy accesses: /replica1/thumbnails/<id>.jpg
# app.mount(f"/{REPLICA_ID}/thumbnails", StaticFiles(directory=THUMB_DIR), name="thumbnails")
